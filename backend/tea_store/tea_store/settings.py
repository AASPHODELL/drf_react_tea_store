"""
Django settings for tea_store project.
...
SECRET_KEY = 'django-insecure-a_pa8fub6!k79op*uizl6m+5$&k!e4k)e8elz2ean#u^4p$p=n'
...
INSTALLED_APPS = [
    # Изначально встроенные в Django приложения
